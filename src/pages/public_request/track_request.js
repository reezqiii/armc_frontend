    ...
    async (no) => {
      ...
      try {
        ...
        const res = await axios.get(
          `${API_URL}/requests/public/track/${idRequest}`,
        );
        setData(res.data);
      } catch (err) {
    ...
    >
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <Paper shadow="md" radius="md" p="lg">
          <h2 className="text-lg font-semibold mb-2">Track Your Request</h2>
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {data.category_account !== null
                      ? CATEGORY_ACCOUNT_OPTIONS.find(
                          (opt) =>
                            String(opt.value) === String(data.category_account),
                        )?.label
                      : "-"}
                  </p>
                </div>
